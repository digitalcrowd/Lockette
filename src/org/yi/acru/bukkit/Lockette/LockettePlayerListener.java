	...
	public void onPlayerCommandPreprocess(PlayerCommandPreprocessEvent event){
		...
		if((command.length == 2) || (command.length == 3)){
			if(command[1].equals("1") || command[1].equals("2") || command[1].equals("3") || command[1].equals("4")){
				...
				if(text.equalsIgnoreCase("[private]") || text.equalsIgnoreCase("private")  || text.equalsIgnoreCase("\"private\"") || text.equalsIgnoreCase(Lockette.altPrivate)) privateSign = true;
