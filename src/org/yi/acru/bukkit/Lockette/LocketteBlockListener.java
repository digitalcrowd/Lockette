...
public class LocketteBlockListener implements Listener{
	...
	public void onBlockPlace(BlockPlaceEvent event){
		...
		if(against.getTypeId() == Material.WALL_SIGN.getId()){
			...
			if(text.equalsIgnoreCase("[private]") || text.equalsIgnoreCase("private")  || text.equalsIgnoreCase("\"private\"")  || text.equalsIgnoreCase(Lockette.altPrivate) || text.equals("[more users]") || text.equalsIgnoreCase(Lockette.altMoreUsers)){
				event.setCancelled(true);
				return;
			}
		}
	...
	public void onSignChange(SignChangeEvent event){
		...
		*/
		...
		if(typeWallSign || (block.getTypeId() == Material.SIGN_POST.getId())){
			...
			if(text.equalsIgnoreCase("[private]") || text.equalsIgnoreCase("private")  || text.equalsIgnoreCase("\"private\"")  || text.equals(Lockette.altPrivate) || text.equals("[more users]") || text.equals(Lockette.altMoreUsers)){
				sign.setLine(0, "");
				sign.setLine(1, "");
				sign.setLine(2, "");
				sign.setLine(3, "");
